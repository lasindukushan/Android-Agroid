...
public class updatedieseform extends AppCompatActivity {
    ...
    EditText Name, Cause_it, Look_like, Can_do, ID;
    Button btnupdate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ID = findViewById(R.id.uinputboxid);
        Name = findViewById(R.id.ueditTextTextPersonName);
        Cause_it = findViewById(R.id.uinputbox2);
        Look_like = findViewById(R.id.uinputbox3);
        Can_do = findViewById(R.id.uinputbox4);

        btnupdate = findViewById(R.id.btn_u3x);
            ...
            public void onClick(View view) {
                ...
                try {
                    if (TextUtils.isEmpty(Name.getText().toString()))
                        ...
                        dbRef.child(String.valueOf(ID.getText())).setValue(dis);
                        Toast.makeText(updatedieseform.this, R.string.dataupdate, Toast.LENGTH_LONG).show();
                    }
                } finally {
